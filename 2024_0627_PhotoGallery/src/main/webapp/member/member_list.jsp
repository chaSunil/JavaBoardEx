	...
	<div id="box">
		...
		<div style="text-align: right; float: right;">
			...
			<c:if test="${ empty sessionScope.user }">
				<input class="btn btn-primary go" type="button" value="로그인" onclick="location.href='http://192.168.219.119:8080/2024_0627_PhotoGallery/member/login_form.do'">
			</c:if>
			...
			<c:if test="${ empty user }">
				<input class="btn btn-primary go" type="button" value="회원가입" onclick="location.href='http://192.168.219.119:8080/2024_0627_PhotoGallery/member/insert_form.do'">
			</c:if>
			<c:if test="${ not empty user }">
			</c:if>
				<input class="btn btn-primary go" type="button" value="캐시충전" onclick="location.href='http://192.168.219.119:8080/2024_0627_PhotoGallery/member/login_form.do'">
			</div>
